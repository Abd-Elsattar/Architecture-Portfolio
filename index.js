...
const projects = [
    { title: 'فيلا العائلة — الساحل', img: 'Images/Villa.jpg', desc: ' تصميم فيلا عائلية بالتركيز على مناظر طبيعية ومساحات معيشة مرنة.' },
    { title: 'مكتب تصميم — القاهرة الجديدة', img: 'Images/Office.jpg', desc: 'مكتب معاصر بمساحات عمل مفتوحة واعتماد على إنارة طبيعية.' },
    { title: 'تحويل مبنى قديم — إعادة استخدام', img: 'Images/oldBulding.jpg', desc: 'مشروع ترميم وتحويل مبنى قديم لاستخدام مختلط، مع مراعاة الاستدامة.' }
];
